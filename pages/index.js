...
import '../styles/libs/animate/animate.css';
...
import '../public/custom-scripts/wow-init';
// import 'animate.css'; 
...
function Home() {
  ...
  useEffect(() => {
    ...
    const handleAddBook = async (e) => {
      ...
      try {
        // Add the new book data to Firestore
        const db = getFirestore();
    ...
    <>
      ...
      {/* <main>
        <section className="hero">
          <h1>Welcome to new monash Website</h1>
      ...
      <>
        <Head>
            <title> Monash Curry n Tandoor | Home</title>
                      ...
                      <div className="col-lg-6">
                          <div className="row g-3">
                              <div className="col-6 text-start">
                                  <img className="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.1s" src="/images/website/about-1.jpg" />
                              </div>
                              <div className="col-6 text-start">
                                  <img className="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.3s" src="/images/website/about-2.jpg" style={{ marginTop: "25%" }} />
                              </div>
                              <div className="col-6 text-end">
                                  <img className="img-fluid rounded w-75 wow zoomIn" data-wow-delay="0.5s" src="/images/website/about-3.jpg" />
                              </div>
                              <div className="col-6 text-end">
                                  <img className="img-fluid rounded w-100 wow zoomIn" data-wow-delay="0.7s" src="/images/website/about-4.jpg" />
                              </div>
                          </div>
                      </div>
                      <div className="col-lg-6">
